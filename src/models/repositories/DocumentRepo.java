...
public class DocumentRepo{
    ...
    public void saveDocument(DocumentEnti document) throws SQLException {
        preparedStatement=connection.prepareStatement("insert into documents(name,subject,nameOfSender,nameOfReceiver,date,time) values (?,?,?,?,?,?)");
    ...
    public List<DocumentEnti> getDocumentsList(String searchQuery, int pageNumber) throws SQLException {
        ...
        while (resultSet.next()) {
            ...
            document.setId(resultSet.getInt("id")).setName(resultSet.getString("name")).setSubject(resultSet.getString("subject"));
    ...
    public DocumentEnti getDocumentInfo(int id) throws SQLException {
        ...
        ResultSet resultSet = preparedStatement.executeQuery();
        resultSet.next();
        return new DocumentEnti().setId(resultSet.getInt("id")).setName(resultSet.getString("name")).setSubject(resultSet.getString("subject"))
